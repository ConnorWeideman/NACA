...
<main id="high-school">
    ...
    <section id="why">
        ...
        <p>Another major function is protecting life forms from the harmful ultra- violet radiation from the sun. This
            is achieved by the small concentrations of ozone in the upper reaches of the stratosphere. Lastly, the
            atmosphere is where the development of clouds occurs. Clouds are collections of millions and trillions of
            tiny water droplets and are the structures responsible for all essential precipitation. </p>
    </section>
    <section id="air">
        <h2>Air Pollution</h2>
        <div id="info">
            <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/industria-fabbrica-ciminiera-170454.jpg">
        ...
        <div id="intro">
            ...
            <p>Depending on the businesses and industries found in your area, emissions and air quality may vary. If you
                ...
                based in South Africa and would like to know what the air quality in your area is like, head to <a
                    href="http://saaqis.environment.gov.za/">SAAQIS</a> for more information. This site is also a
                platform
                available for you to report any facilities you may think are emitting hazardous amounts of air
                pollution.
            </p>
        </div>
        <div id="wrap">
            <div class="emission">
                <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/1280px-Sunilan_Sellutehdas_Kotka.jpg">
                <div class="info">
                    <h3>Criteria Pollutants</h3>
                    <p>Criteria pollutants are responsible for the deterioration of health in individuals. They cause
                        respiratory problems and other health complications. Criteria pollutants such as sulfur dioxide
                        and nitrogen oxides also cause acid rain which is harmful for the environment.</p>
                </div>
            </div>
            <div class="emission">
    ...
    <section id="criteria">
        ...
        <div id="monitoring">
            ...
            <p>There are many different types of air quality control instruments that are used to measure the
                ...
                ozone, particulate matter and nitrogen dioxide.</p>
            <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2020/01/images-35.jpg">
        </div>
        <div id="effects">
            <h3>Affects of Criteria Pollutant Emissions on People and Ecosystems</h3>
            <p>Click here to see interactive diagrams of these affects.</p>
    ...
    <section id="gh">
        ...
        <section id="greenhouse">
            <div id="flex">
                <div id="wrap">
                    <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/A-17-1024x731.png">
                </div>
                <div id="info">
                    <h3>The Greenhouse Effect</h3>
                    <p>Greenhouses are large glass structures that are ideal for growing plants all year round.
                        Greenhouses make plant growth in the winter possible because heat from the sun is trapped inside
        ...
        <section id="effects">
            <h3>The Effects of Greenhouse Gas Emissions on the Environment</h3>
            <div id="temperatures">
            ...
            <div id="desertification">
                ...
                <p>Areas surrounding major deserts suffer severely from these increases in temperatures and decreases in
                    rainfall. As they become more and more dry they begin to replicate the climates of the deserts they
                    lie close to (desertification). This means that they can no longer support the plant and animal life
                    they could before and biodiversity decreases.</p>
            </div>
            <div id="img"
                style="background-image:url('<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/25349746455_02c61b1c35_o-scaled.jpg')">
            </div>
            <div id="ice">
    ...
    <section id="sources">
        ...
        <div id="wrap">
            <a href="<?php bloginfo('wpurl')?>/energy-production" class="circle" style="background:#c50">
                <h3><span id="text">Energy</span></h3>
            </a>
            <a href="<?php bloginfo('wpurl')?>/industries" class="circle" style="background:#09aaea">
                <h3><span id="text">Industry</span></h3>
            </a>
            <a href="<?php bloginfo('wpurl')?>/mining" class="circle" style="background:#eae309">
                <h3><span id="text">Mining</span></h3>
            </a>
            <a href="<?php bloginfo('wpurl')?>/agriculture" class="circle" style="background:#00B000">
                <h3><span id="text">Agriculture</span></h3>
            </a>
            <a href="<?php bloginfo('wpurl')?>/transport" class="circle" style="background:#31056e">
                <h3><span id="text">Transport</span></h3>
            </a>
            <a href="<?php bloginfo('wpurl')?>/waste" class="circle" style="background:#960658">
                <h3><span id="text">Waste</span></h3>
            </a>
        </div>
    </section>
    ...
    <section id="ngo">
        ...
        <p>There are many influential NGO's that are also involved in trying to improve air quality not only in South
            ...
            aware of the issue they are supporting. Advocacy involves trying to get government to pass laws and respond
            to the issues you think are important, this could include anything from organizing peaceful protests to
            getting people to sign a petition.</p>
    </section>
    <section id="solutions">
        <h2>Solutions</h2>
        <div class="wrap">
            <h3>Using Sustainable Energy Sources</h3>
            <p>Sustainable energy sources produce electricity and power without the use of fossil fuels. There are
                several types that have been implemented all over the world to decrease air pollution from the
                production of electricity. Because criteria pollutants and greenhouse gases are both emitted from the
                same sources, by using sustainable energy options you decrease the negative affects on both the
                environment and on peoples health.</p>
        </div>
        <div id="row">
            <div class="energy">
                <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/Solar-scaled.jpg">
                <div class="content">
                    <h4>Solar power</h4>
            ...
            <div class="energy">
                <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/Wind-Power-scaled.jpg">
                <div class="content">
                    <h4>Wind Power</h4>
                    <p>Wind power is most effective in places that experience high wind speeds and gales on a regular
                        basis.
                        Huge
                        blades are positioned on poles which extend relatively high up into the atmosphere (these are
                        known
                        as
                        wind
                        turbines), the wind then turns these large blades creating mechanical power which powers
                        electrical
                        generators. Places where many of these turbines are found together are known as wind farms. Wind
                        farms
                        do to
                        some extent disadvantage the environment as they require large pieces of land, more land than an
                        otherwise
                        conventional coal burning power station.</p>
                </div>
            </div>
            <div class="energy">
                <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/2530229887_edf4ed30a9_o.jpg">
                <div class="content">
                    <h4>Hydro Power</h4>
                    <p>Hydro means water, therefore hydro power refers to energy or electricity generated by falling or
                        fast-
                        running water. This form of energy generation has also been used to power irrigation systems as
                        well as many other
                        kinds of
                        equipment. These power stations enormously reduce the amount of emissions released into the
                        atmosphere. In order for hydro power stations to be established, dams need to be constructed.
                        Dams are created by building a wall somewhere along a rivers course, this means that water that
                        would
                        normally flow downstream is now trapped behind a dam wall. This can be
                        damaging to the environment because it can
                        often
                        lead to droughts, floods and decreased biodiversity for the areas surrounding the river
                        downstream.
                    </p>
                </div>
            </div>
        ...
        <div class="wrap">
            ...
            <div class="solution">
                ...
                <h3>Finding Alternative Fuels for Transport</h3>
            ...
            <div class="solution">
                <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/39262842134_9612e5e84a_o-scaled.jpg">
                <h3>Plant More Trees and Vegetation</h3>
                <p>Plants and trees need carbon dioxide to grow, therefore by increasing the number of plants you
                    increase
                    the
                    amount of carbon dioxide that is used up and converted into oxygen (a gas essential to all living
                    things)
    ...
    <section id="you-do">
        ...
        <div id="wrap">
            <div class="thing">
                <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/5275152255_a1f168fdc2_o-scaled.jpg">
                <div class="overlay">
                    <h3>Save electricity</h3>
                    <p>Turning lights off and saving electricity decreases the amount pollutants that are released into
                        the atmosphere as less coal is burned to produce the power that is being wasted.</p>
                </div>
            </div>
            <div class="thing">
                <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/33403813890_8c7c3b7900_o-scaled.jpg">
                <div class="overlay">
                    <h3>Use public transport or carpool</h3>
                    <p>Public transport prevents every individual from needing to use their own cars, this decreases the
                        amount of emissions into the atmosphere. </p>
                </div>
            </div>
            <div class="thing">
                <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/39262842134_9612e5e84a_o-scaled.jpg">
                <div class="overlay">
                    <h3>Plant trees</h3>
                    <p>Plants and trees use carbon dioxide during the process of photosynthesis (how plants produce food
                        and allow growth), this means that the more plants there are the more carbon dioxide will be
                        consumed and the less severe the affects of global warming will be.</p>
                </div>
            </div>
            <div class="thing">
                <img
                    src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/glow-glowing-bulb-object-royalty-free-thumbnail.jpg">
                <div class="overlay">
                    <h3>Use energy efficient light bulbs</h3>
                    <p>Energy efficient light bulbs and appliances use less electricity and therefore they result in
                        less emissions into the atmosphere from power stations.</p>
                </div>
            </div>
            <div class="thing">
                <img
                    src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/big_152285_800px-Trash_Recycling_with_Disposal_Containers.jpg">
                <div class="overlay">
                    <h3>Recycle</h3>
                    <p>By recycling you decrease the need for the extraction of raw materials and more energy to be used
                        making products to replace the ones that have been thrown away.</p>
                </div>
            </div>
            <div class="thing">
                <img src="<?php bloginfo('wpurl')?>/wp-content/uploads/2019/12/6307672876_332dda1965_o.jpg">
                <div class="overlay">
                    <h3>Save water</h3>
                    <p>Electricity is needed to purify and pump water to where it is needed. Saving water therefore
                        helps decrease power station emissions. </p>
                </div>
            </div>
        </div>
    </section>
